...
/// both sides page together.
/// Devices with side strips (Razer Stream Controller) keep an independent set of pages per side,
/// tagged <see cref="Left"/> / <see cref="Right"/>, so swiping one strip only cycles that side.
/// </remarks>
