...
/// <see cref="DeviceRegistry.DeviceInfo"/> is a value-compared type catalog entry (DI singleton, registry key).
/// The serial lives here so two physically identical units stay distinct
/// without polluting the type catalog.
/// <see cref="Serial"/> may be null for devices without a real iSerial;
/// everything then falls back to the slug-only scope.
/// </remarks>
