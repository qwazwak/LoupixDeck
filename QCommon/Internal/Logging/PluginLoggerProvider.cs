...
internal sealed class PluginLoggerProvider(IPluginLogger actualLogger) : ILoggerProvider
{
    ...
    private sealed class PluginLoggerHolder(IPluginLogger actualLogger)
    {
    ...
    private sealed class Logger(PluginLoggerHolder holder, string name) : ILogger
    {
        private readonly PluginLoggerHolder holder = holder;
